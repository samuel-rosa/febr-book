...
Table: Representação da estrutura da tabela *dataset* com os items das suas primeiras três e últimas duas
linhas. O símbolo `...` indica a existência de outros items nas linhas intermediárias, enquanto <???>

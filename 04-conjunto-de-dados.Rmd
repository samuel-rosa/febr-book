...
da sua primeira versão, dependem da provisão de dados mínimos sobre aquele conjunto de dados. No **febr** esses
...
conjunto de dados no **febr**, a segunda ao título do conjunto de dados, e assim por diante, até as últimas 
...
Os itens da tabela *dataset* são descritos em detalhe nas seções a seguir.

...
no conjunto de dados durante ou após a sua inserção no **febr**, resultando assim em uma nova versão, então a 
data de publicação é a data em que essa nova do conjunto de dados foi disponibilizada no **febr**.
